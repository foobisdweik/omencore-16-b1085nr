...
| File | SHA256 |
|------|--------|
| `OmenCoreSetup-2.6.0.exe` | `B770E968A6EAEBF168BFF15D055E29F03943E916F6B0BB8C3CE15FDE9D2E7D54` |
| `OmenCore-2.6.0-win-x64.zip` | `96D6C841C1005B3D558CFC77B0F5A886624F0C08013F323B0336052765026108` |

### Linux
| File | SHA256 |
|------|--------|
| `OmenCore-2.6.0-linux-x64.zip` | `2BF09D94A6E02129D500C1718C02D48F58D89D68680B2E1216BEBCB2B6DB5E40` |
